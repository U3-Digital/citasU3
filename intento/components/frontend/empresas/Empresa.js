...
const Empresa = (empresa) =>{
    ...
    return(
        <div className={`border-blue-200 m-2 border-t-4  bg-white rounded p-6  shadow-lgv xl:w-full sm:w-full`}>
            ...
            <button type="button" className="flex w-full justify-center  items-center bg-blue-400 py-2 px-4 text-white rounded text-xs uppercase font-bold mt-3" onClick={() =>editarCita(id)}>
                Agendar nueva cita
